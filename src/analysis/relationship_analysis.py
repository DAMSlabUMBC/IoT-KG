...
class TripleAnalysis:
    def __init__(self):
        #Initializing the LLM to be used and defining the prompt
        self.llm = ChatOllama(model="gemma3:4b")
        
        #Writing a prompt with placeholders to be filled in
    ...
    def analyze(self, entities: List[str], text:str) -> List[Triple]:
        #Filling in the prompt with the parameters specified
